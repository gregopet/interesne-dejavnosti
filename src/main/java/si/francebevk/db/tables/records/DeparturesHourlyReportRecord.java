...
public class DeparturesHourlyReportRecord extends TableRecordImpl<DeparturesHourlyReportRecord> implements Record7<String, DayOfWeek, Short, String[], String[], NamedStringsRecord[], String[]> {

    private static final long serialVersionUID = 590307027;
    ...
    /**
     * Setter for <code>public.departures_hourly_report.not_included_today</code>.
     */
    public void setNotIncludedToday(String... value) {
        set(6, value);
    }

    /**
     * Getter for <code>public.departures_hourly_report.not_included_today</code>.
     */
    public String[] getNotIncludedToday() {
        return (String[]) get(6);
    }
     ...
     */
    @Override
    public Row7<String, DayOfWeek, Short, String[], String[], NamedStringsRecord[], String[]> fieldsRow() {
     ...
     */
    @Override
    public Row7<String, DayOfWeek, Short, String[], String[], NamedStringsRecord[], String[]> valuesRow() {
    ...
    public Field<String[]> field7() {
        return DeparturesHourlyReport.DEPARTURES_HOURLY_REPORT.NOT_INCLUDED_TODAY;
    }
     ...
     */
    @Override
    public DeparturesHourlyReportRecord value7(String... value) {
        setNotIncludedToday(value);
        return this;
    }
     ...
     */
    @Override
    public DeparturesHourlyReportRecord values(String value1, DayOfWeek value2, Short value3, String[] value4, String[] value5, NamedStringsRecord[] value6, String[] value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DeparturesHourlyReportRecord(String pupilGroup, DayOfWeek day, Short leaveMinutes, String[] stillHere, String[] leave, NamedStringsRecord[] atActivities, String[] notIncludedToday) {
        super(DeparturesHourlyReport.DEPARTURES_HOURLY_REPORT);
